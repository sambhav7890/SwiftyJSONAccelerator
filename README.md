...
# SwiftyJSONAccelerator (Model file Generator For Swift 4) macOS app and Command line interface.
...
- **With CLI:** Download the repo, run the script and you are good to go!
  ...
  ```
  git clone https://github.com/sambhav7890/SwiftyJSONAccelerator.git
...
- [Swift4](https://developer.apple.com/documentation/swift/codable)
...
![Preview](https://github.com/sambhav7890/SwiftyJSONAccelerator/raw/master/preview.png)
...
![Preview](https://github.com/sambhav7890/SwiftyJSONAccelerator/raw/master/preview-cli.png)
...
- See [test.config.json](https://github.com/sambhav7890/SwiftyJSONAccelerator/blob/master/SwiftyJSONAcceleratorTests/Support%20Files/MultipleModelTests/test_config.json) is an example. The config file should be in the same folder as the models.

- You can use `./swiftyjsonaccelerator generate -p path/to/json/files` to load JSON files at a particular location.

## Adding New Libraries

- Add a new type in `JSONMappingLibrary` in [Constants.swift](https://github.com/sambhav7890/SwiftyJSONAccelerator/blob/master/Core/Constants.swift).
...
There is a lot more to do, follow the [issues section](https://github.com/sambhav7890/SwiftyJSONAccelerator/issues), I usually try to follow up or keep the list updated with any new ideas which I plan to implement.
